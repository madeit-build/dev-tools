...
const g: Graph = {
  ...
  nodes: [
    { id: "fleet:fleet", type: "fleet", label: "fleet", host: null, attrs: {}, provenance: { files: [] } },
    { id: "host:box", type: "host", label: "box", host: "box", attrs: {}, provenance: { files: [] } },
    { id: "host:cerberus", type: "host", label: "cerberus", host: "cerberus", attrs: {}, provenance: { files: [] } },
    { id: "service:box/caddy", type: "service", label: "caddy", host: "box", attrs: { lifecycle: "running" }, provenance: { files: [] } },
    { id: "service:box/seed", type: "service", label: "seed", host: "box", attrs: { lifecycle: "oneshot" }, provenance: { files: [] } },
    { id: "vhost:box/chat.example", type: "vhost", label: "chat.example", host: "box", attrs: {}, provenance: { files: [] } },
    { id: "module:nix/nixos/chat.nix", type: "module", label: "nix/nixos/chat.nix", host: null, attrs: {}, provenance: { files: [] } },
  ],
  edges: [
    { id: "c1", from: "fleet:fleet", to: "host:box", type: "contains", source: "declared", evidence: null },
    { id: "c2", from: "fleet:fleet", to: "host:cerberus", type: "contains", source: "declared", evidence: null },
    { id: "c3", from: "host:box", to: "service:box/caddy", type: "contains", source: "declared", evidence: null },
    { id: "c4", from: "host:box", to: "service:box/seed", type: "contains", source: "declared", evidence: null },
    { id: "c5", from: "host:box", to: "vhost:box/chat.example", type: "contains", source: "declared", evidence: null },
    { id: "p1", from: "vhost:box/chat.example", to: "service:box/caddy", type: "proxies-to", source: "inferred", evidence: "x" },
    { id: "d1", from: "vhost:box/chat.example", to: "module:nix/nixos/chat.nix", type: "declared-by", source: "declared", evidence: null },
  ],
  ledger: [],
};
...
describe("visibleFor, runtime lens", () => {
  it("shows the hosts at the fleet level, and not their contents", () => {
    ...
    expect(v.nodes.map((n) => n.id).sort()).toEqual(["host:box", "host:cerberus"]);
  });
...
describe("visibleFor, declaration lens", () => {
  ...
  it("shows the same runtime nodes in both lenses, so the flip does not relocate you", () => {
    const ids = (lens: "runtime" | "declaration") =>
      visibleFor(g, { path: ["box"], lens, selected: null })
        .nodes.filter((n) => n.type !== "module" && n.type !== "option" && n.type !== "input")
        .map((n) => n.id)
        .sort();
  ...
  it("keeps a selected node visible after the flip, which is the whole promise", () => {
    ...
    const after = visibleFor(g, { path: ["box"], lens: "declaration", selected });
